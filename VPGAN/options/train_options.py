...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoint_dir', type=str, default='', help='VLM weight')
        parser.add_argument('--ori', type=str, default='HE', help='ori')
        parser.add_argument('--tar', type=str, default='PAS', help='tar')
